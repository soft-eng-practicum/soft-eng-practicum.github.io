...
title: "Joshua Walton" # Your name or your organization's name (if not GGC) (e.g., "Dr. Cengiz Gunay" or "Charity Organization")
sponsor_key: "joshua-walton" # A unique value that represents you as a partner (e.g., "cengiz-gunay" or "charity-organization")
...
contact_email: "jwalton@ggc.edu" # Your preferred contact email address (e.g., "cgunay@ggc.edu")
