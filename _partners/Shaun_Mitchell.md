...
title: "Shaun Mitchell" # Your name or your organization's name (if not GGC) (e.g., "Dr. Cengiz Gunay" or "Charity Organization")
sponsor_key: "shaun-mitchell" # A unique value that represents you as a partner (e.g., "cengiz-gunay" or "charity-organization")
...
contact_name: "Shaun" # Your preferred name or name of contact (e.g., "Dr. Gunay")
contact_email: "smitchell@ggc.edu" # Your preferred contact email address (e.g., "cgunay@ggc.edu")
