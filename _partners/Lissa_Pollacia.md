...
title: "Dr. Lissa Pollacia" # Your name or your organization's name (if not GGC) (e.g., "Dr. Cengiz Gunay" or "Charity Organization")
sponsor_key: "lissa-pollacia" # A unique value that represents you as a partner (e.g., "cengiz-gunay" or "charity-organization")
description: "IT Professor, GGC" # A short description about you (e.g., "I'm a professor at GGC!")
...
website: "https://www.ggc.edu/directory/lissa-pollacia" # Your website (e.g., "https://ggc.edu")
...
contact_name: "Dr. Pollacia" # Your preferred name or name of contact (e.g., "Dr. Gunay")
contact_email: "lpollaci@ggc.edu" # Your preferred contact email address (e.g., "cgunay@ggc.edu")
