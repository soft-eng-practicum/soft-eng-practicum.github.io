...
title: "Lukas Walsh" # Your name or your organization's name (if not GGC) (e.g., "Dr. Cengiz Gunay" or "Charity Organization")
sponsor_key: "lukas-walsh" # A unique value that represents you as a partner (e.g., "cengiz-gunay" or "charity-organization")
...
contact_name: "Lukas" # Your preferred name or name of contact (e.g., "Dr. Gunay")
contact_email: "lwalsh@ggc.edu" # Your preferred contact email address (e.g., "cgunay@ggc.edu")
