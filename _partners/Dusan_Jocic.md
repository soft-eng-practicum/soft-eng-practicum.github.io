...
title: "Dušan Jocić" # Your name or your organization's name (if not GGC) (e.g., "Dr. Cengiz Gunay" or "Charity Organization")
sponsor_key: "dusan-jocic" # A unique value that represents you as a partner (e.g., "cengiz-gunay" or "charity-organization")
description: "Open Source Developer" # A short description about you (e.g., "I'm a professor at GGC!")
...
website: "https://github.com/TheDushan" # Your website (e.g., "https://ggc.edu")
...
location: "Serbia" # Your general georgraphic location (e.g., "Lawrenceville, GA")
contact_name: "Dušan" # Your preferred name or name of contact (e.g., "Dr. Gunay")
contact_email: "dusanjocic@msn.com" # Your preferred contact email address (e.g., "cgunay@ggc.edu")
...
git: "https://github.com/TheDushan" # A link to your public Git account, if any (e.g., "https://github.com/username")
